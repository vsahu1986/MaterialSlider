...
import youtubeapidemo.adapter.DemoArrayAdapter;
import youtubeapidemo.adapter.DemoListViewItem;
...
public final class IntentsDemoActivity extends Activity implements OnItemClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        DemoArrayAdapter adapter = new DemoArrayAdapter(this, R.layout.list_item, intentItems);
